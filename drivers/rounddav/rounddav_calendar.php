...
class rounddav_calendar extends kolab_storage_dav_folder
{
    public $ready         = false;
    public $rights        = 'lrs';
     ...
     *
     * @see rounddav_driver::edit_calendar()
     */
