...
class rounddav_invitation_calendar extends kolab_invitation_calendar
{
    public $id = '__rounddav_invitation__';
    ...
    {
        $exceptions = [
            kolab_driver::INVITATIONS_CALENDAR_PENDING,
            kolab_driver::INVITATIONS_CALENDAR_DECLINED,
            kolab_driver::BIRTHDAY_CALENDAR_ID,
        ];
